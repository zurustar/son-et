...
- [x] 17. エンドツーエンドテスト
  - [x] 17.1 外部タイトル指定での起動テスト
  - [x] 17.2 embedタイトル（単一）での起動テスト
  - [x] 17.3 embedタイトル（複数）での選択画面テスト
  - [x] 17.4 ヘッドレスモードでの起動テスト
  - [x] 17.5 タイムアウト機能のテスト

- [x] 18. エラーハンドリングのテスト
  - [x] 18.1 無効なコマンドライン引数のテスト
  - [x] 18.2 存在しないディレクトリ指定のテスト
  - [x] 18.3 スクリプトファイルが存在しない場合のテスト
  - [x] 18.4 Shift-JIS変換エラーのテスト

- [x] 19. ドキュメントの整備
  - [x] 19.1 README.md の作成
  - [x] 19.2 使用例の追加
  - [x] 19.3 ビルド手順の記載

- [x] 20. 最終確認
  - [x] 20.1 すべてのユニットテストが通ることを確認
  - [x] 20.2 すべての統合テストが通ることを確認
  - [x] 20.3 コードレビュー
  - [x] 20.4 requirements.md の受け入れ基準を満たしているか確認

## フェーズ6: エントリーポイント指定

- [x] 21. ビルドスクリプトの拡張
  - [x] 21.1 TFYファイルパス指定時の親ディレクトリ抽出を実装
  - [x] 21.2 エントリーファイル存在チェックの実装
  - [x] 21.3 title.json生成機能の実装
  - [x] 21.4 ディレクトリ指定との後方互換性を維持

- [x] 22. pkg/cli の拡張
  - [x] 22.1 TFYファイルパス指定時の親ディレクトリ抽出を実装
  - [x] 22.2 ディレクトリ指定との後方互換性を維持

- [x] 23. pkg/title の拡張
  - [x] 23.1 FillyTitleにEntryFileフィールドを追加
  - [x] 23.2 title.json読み込み機能の実装
  - [x] 23.3 エントリーポイント情報のテスト
