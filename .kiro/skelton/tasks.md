...
- [ ] 12. タイトル選択画面の実装
  - [ ] 12.1 Update メソッドの実装（選択画面モード）
  - [ ] 12.2 Draw メソッドの実装（選択画面モード）
  - [ ] 12.3 矢印キーでの選択移動処理
  - [ ] 12.4 Enterキーでの決定処理
  - [ ] 12.5 Escキーでの終了処理
  - [ ] 12.6 タイトル選択画面のテスト
...
- [ ] 13. 仮想デスクトップの実装
  - [ ] 13.1 Update メソッドの実装（デスクトップモード）
  - [ ] 13.2 Draw メソッドの実装（デスクトップモード）
  - [ ] 13.3 背景色 #0087C8 の描画
  - [ ] 13.4 タイムアウト処理の実装
  - [ ] 13.5 仮想デスクトップのテスト

- [ ] 14. ヘッドレスモードの実装
  - [ ] 14.1 RunHeadless 関数の実装
  - [ ] 14.2 標準入出力でのタイトル選択
  - [ ] 14.3 ヘッドレスモードでのタイムアウト処理
  - [ ] 14.4 ヘッドレスモードのテスト

- [ ] 15. pkg/window の統合
  - [ ] 15.1 Run 関数の実装
  - [ ] 15.2 Ebitengineの初期化とエラーハンドリング
  - [ ] 15.3 ウィンドウ設定（サイズ、タイトル）

- [ ] 16. pkg/app へのGUI機能の統合
  - [ ] 16.1 selectTitle メソッドの完全実装
  - [ ] 16.2 runDesktop メソッドの実装
  - [ ] 16.3 ヘッドレスモードとGUIモードの切り替え
  - [ ] 16.4 GUI統合テスト
