...
func TestSpriteSystemIntegration_ParentChildPositionInheritance(t *testing.T) {
	...
	expectedX := 100.0 + 4.0 + 0.0 + 10.0 // window.X + borderThickness + picture.X + cast.X
	expectedY := 50.0 + 24.0 + 0.0 + 20.0 // window.Y + (borderThickness + titleBarHeight) + picture.Y + cast.Y
